...
<div class="space-y-6">
    ...
    <div class="p-6 rounded-3xl bg-gradient-to-r from-emerald-950 via-emerald-900 to-emerald-950 text-white shadow-xl flex flex-wrap items-center justify-between gap-4 border border-gold-500/30">
        <div class="space-y-1 max-w-2xl">
            ...
            <p class="text-xs text-slate-300 leading-relaxed">انسخ النص من ملف Word والصقه مباشرة هنا؛ ستقوم الأداة بتهذيب النص، تحويل الأرقام، ضبط الآيات القرآنية بالخط العثماني، تمييز العناوين باللون الأحمر والفروع بالبني، وإدراج الصلاة النبوية التامة «صلى الله عليه وآله وسلم»، لتجهيزه للنشر الفوري على الموقع.</p>
        </div>
    ...
    <div class="p-6 rounded-2xl bg-slate-100/80 border border-slate-200 text-xs space-y-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-slate-600 leading-relaxed">
            ...
            <div class="bg-white p-3.5 rounded-xl border border-slate-200/80 space-y-1">
                ...
                <span>الآيات بالخط العثماني باللون الأحمر (#BB1111) بين أقواس ﴿ ﴾، مراجع السور باللون الذهبي، والصلاة النبوية الشريفة «صلى الله عليه وآله وسلم».</span>
            </div>
            <div class="bg-white p-3.5 rounded-xl border border-slate-200/80 space-y-1">
