...
<div class="space-y-6">
    ...
    <div class="p-6 rounded-3xl bg-gradient-to-r from-emerald-950 via-emerald-900 to-emerald-950 text-white shadow-xl flex flex-wrap items-center justify-between gap-4 border border-gold-500/30">
        <div class="space-y-1 max-w-2xl">
            ...
            <p class="text-xs text-slate-300 leading-relaxed">انسخ النص من ملف Word والصقه مباشرة هنا؛ ستقوم الأداة بتهذيب النص، تحويل الأرقام، ضبط الآيات القرآنية بالخط العثماني، تمييز العناوين باللون الأحمر والفروع بالبني، وإدراج رمز الصلاة النبوية التامة ﵌ (صلى الله عليه وآله وسلم)، لتجهيزه للنشر الفوري على الموقع.</p>
        </div>
