...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
            <h2 class="text-lg sm:text-xl font-bold text-slate-800">إدارة الصوتيات والمرئيات والريلز</h2>
            <p class="text-xs text-slate-500 mt-0.5 sm:mt-1">إضافة محاضرات صوتية ومرئيات يوتيوب والريلز مع الكشف عن المدة.</p>
        </div>
        <a href="{{ route('admin.media.create') }}" class="self-start sm:self-auto px-4 py-2 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-xs rounded-xl shadow-xs transition flex items-center gap-2">
            ...
            <table class="w-full text-right text-xs">
                <thead class="bg-slate-50 text-slate-600 border-b border-slate-200 whitespace-nowrap">
                    <tr>
                        ...
                        <th class="p-3.5 sm:p-4 font-bold">الموسم</th>
                        <th class="p-3.5 sm:p-4 font-bold">المدة</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        <td class="p-3.5 sm:p-4 font-bold text-slate-800 min-w-[180px] max-w-xs truncate">{{ $m->title }}</td>
                        ...
                        <td class="p-3.5 sm:p-4 text-slate-500 whitespace-nowrap">
                        ...
                        <td class="p-3.5 sm:p-4 text-slate-500 font-mono whitespace-nowrap">{{ $m->duration ?? '-' }}</td>
                        <td class="p-3.5 sm:p-4 text-slate-500 whitespace-nowrap">{{ $m->views_count }}</td>
